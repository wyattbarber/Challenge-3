...
c++ -O0 -fopenmp -Wall -shared -g -std=c++20 -I ~/include/eigen/ -I ~/include/eigen/unsupported/ -fPIC $(python3 -m pybind11 --includes) $SCRIPT_PATH/../bindings.cpp -o $SCRIPT_PATH/neuralnet$(python3-config --extension-suffix)
